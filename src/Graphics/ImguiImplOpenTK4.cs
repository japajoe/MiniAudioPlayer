...
//             public WindowCallbacks(Application window)
//             {
//                 Window = window;
//             }
...
//         public static ImGuiKey TranslateKey(KeyCode key)
//         {
//             if (key >= KeyCode.Alpha0 && key <= KeyCode.Alpha9)
//                 return key - KeyCode.Alpha0 + ImGuiKey._0;
...
//         private static void UpdateKeyModifiers(ImGuiIOPtr io, IntPtr window)
//         {
//             io.AddKeyEvent(ImGuiKey.ModCtrl, Input.GetKeyDown(KeyCode.LeftControl) || Input.GetKeyDown(KeyCode.RightControl));
//             io.AddKeyEvent(ImGuiKey.ModShift, Input.GetKeyDown(KeyCode.LeftShift) || Input.GetKeyDown(KeyCode.RightShift));
//             io.AddKeyEvent(ImGuiKey.ModAlt, Input.GetKeyDown(KeyCode.LeftAlt) || Input.GetKeyDown(KeyCode.RightAlt));
//             io.AddKeyEvent(ImGuiKey.ModSuper, Input.GetKeyDown(KeyCode.LeftSuper) || Input.GetKeyDown(KeyCode.RightSuper));
//         }
...
//             GLFW.WindowHint(GLFW.FLOATING, viewport.Flags.HasFlag(ImGuiViewportFlags.TopMost) ? 1 : 0);
